# orm-rest-data-panache-security-native-reproducer
...
You can then execute your native executable with: `./target/orm-rest-data-panache-security-native-reproducer-1.0.0-SNAPSHOT-runner`
